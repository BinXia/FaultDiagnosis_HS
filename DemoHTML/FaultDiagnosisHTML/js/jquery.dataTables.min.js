...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"无记录",sInfo:"第 _START_ 条 至 第 _END_ 条，共 _TOTAL_ 条记录",sInfoEmpty:"第 0 条 至 第 0 条，共 0 条记录",sInfoFiltered:"(共有 _MAX_ 条记录)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 条记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查询:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有匹配记录"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
